...
3. The plugin updates the first selected texture in place: its name, package,
   resolution, and texture settings stay the same, and only its alpha channel is
   replaced with the second selected texture.
